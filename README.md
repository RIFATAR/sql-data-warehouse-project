...
|-------------------------|------------------------------------------------|
| datasets/               | Raw datasets (ERP & CRM, CSV format)           |
| docs/                   | Documentation, diagrams, data catalog          |
| scripts/bronze/         | Bronze layer SQL scripts (raw ingestion)       |
| scripts/silver/         | Silver layer SQL scripts (data cleaning)       |
| scripts/gold/           | Gold layer SQL scripts (star schema)           |
